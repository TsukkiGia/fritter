...
import {downvoteRouter} from '../server/downvote/router';
import {followRouter} from '../server/follow/router';
import {notificationRouter} from '../server/notification/router';
import {hiddenFreetRouter} from '../server/hiddenfreets/router';
